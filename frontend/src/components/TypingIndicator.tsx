...
export default function TypingIndicator() {
  ...
  return (
    <div className="flex items-end gap-2 md:gap-3 mb-4 justify-start">
      ...
      <div className="flex flex-col gap-1 min-w-0" style={{ maxWidth: 'calc(80% - 2.5rem)' }}>
        <div className="chat-bubble bg-gray-200 dark:bg-gray-700 px-3 py-2 md:px-4 md:py-3">
        ...
        <GenerationTimer isGenerating={true} />
      </div>
    </div>
  );
}
