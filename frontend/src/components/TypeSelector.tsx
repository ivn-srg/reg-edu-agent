...
export default function TypeSelector() {
  const { currentType, setCurrentType, setCurrentConversationId } = useChatStore();
  ...
  return (
    <select
      value={currentType || ''}
      onChange={(e) => {
        const newType = (e.target.value as MessageType) || null;
        setCurrentType(newType);
        // Сбрасываем текущий conversation при смене типа
